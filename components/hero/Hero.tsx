    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1400px] px-5 md:px-8">
        <div className="max-w-4xl">
          <span
            data-hero-item
            className="border-brand-green/25 text-brand-deep mb-5 inline-flex items-center gap-2 rounded-full border bg-white/70 px-3 py-1 text-[11px] font-medium backdrop-blur-sm"
          >
          ...
          <h1
            data-hero-title
            className="font-display-tight text-ink-1 text-balance text-[clamp(2.1rem,4.6vw,4rem)] leading-[0.96]"
          >
          ...
          <p
            data-hero-item
            className="text-ink-2 mt-4 max-w-xl text-[clamp(0.9rem,1.05vw,1rem)] leading-relaxed"
          >
          ...
          <div
            ...
            aria-hidden="true"
            data-hero-item
            className="mt-7 hidden h-[116px] w-full max-w-[680px] lg:block"
          />

          {/* Mobile and tablet: the field lives inline, no morph. */}
          <div data-hero-item className="relative mt-6 h-[116px] w-full lg:hidden">
            <SearchField />
            <Suggestions />
          </div>
          ...
          <p data-hero-item className="text-ink-4 mt-6 text-[11.5px]">
      ...
      <div className="pointer-events-none absolute inset-y-0 right-0 hidden w-full lg:flex">
        <div className="mx-auto flex h-full w-full max-w-[1400px] items-start justify-end px-5 pt-[124px] md:px-8">
          <div className="pointer-events-auto h-[450px] w-[400px]">
            <ChatWindow />
          </div>
        </div>
      </div>
